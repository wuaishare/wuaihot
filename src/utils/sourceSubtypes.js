  ...
  bilibili: [
    {
      ...
      param: "type",
      items: [
        { label: "综合热门", value: "popular", apiParams: { type: "popular" } },
        { label: "全站排行榜", value: "all", apiParams: { type: "0" } },
        { label: "动画", value: "animation", apiParams: { type: "1" } },
        { label: "音乐", value: "music", apiParams: { type: "3" } },
        { label: "游戏", value: "game", apiParams: { type: "4" } },
        { label: "娱乐", value: "entertainment", apiParams: { type: "5" } },
        { label: "科技", value: "tech", apiParams: { type: "188" } },
        { label: "影视", value: "film", apiParams: { type: "181" } },
        { label: "鬼畜", value: "kichiku", apiParams: { type: "119" } },
        { label: "舞蹈", value: "dance", apiParams: { type: "129" } },
        { label: "时尚", value: "fashion", apiParams: { type: "155" } },
        { label: "生活", value: "life", apiParams: { type: "160" } },
        { label: "国创相关", value: "guochuang", apiParams: { type: "168" } },
        { label: "知识", value: "knowledge", apiParams: { type: "36" } },
        { label: "美食", value: "food", apiParams: { type: "211" } },
        { label: "动物圈", value: "animals", apiParams: { type: "217" } },
        { label: "汽车", value: "auto", apiParams: { type: "223" } },
        { label: "运动", value: "sports", apiParams: { type: "234" } },
      ],
    },
  ],
  "super-deals": [
