...
assert.match(store, /"apple-music": \{[\s\S]{0,260}categoryIds: \[[\s\S]{0,220}"entertainment-music-songs"[\s\S]{0,220}"entertainment-music-albums"[\s\S]{0,220}"entertainment-music-playlists"/);
